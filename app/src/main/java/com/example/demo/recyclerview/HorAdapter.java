...
public class HorAdapter extends RecyclerView.Adapter<HorAdapter.LinearViewHolder> { // Adapter 类有一个泛型
    ...
    public HorAdapter(Context context, OnItemClickListener listener){//实现构造方法， 给context赋值
